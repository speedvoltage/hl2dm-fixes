...
public:
	...
	CNetworkVar( bool,		m_bFireOnEmpty );		// True when the gun is empty and the player is still holding down the attack key(s)
	CNetworkVar( bool,		m_bFiringWholeClip );		// Are we in the middle of firing the whole clip;
	// Weapon art
